...
from TSPEnv_ex import TSPEnv as Env
...
name = 'train_tsp_n100_lehd-finetuning' + d_time
...
class TSPTrainer:
    ...
    def run(self):
        ...
        for epoch in range(self.start_epoch, self.trainer_params['epochs']+1):
            ...
            metrics = {
                ...
                "train_student_score": train_student_score,
    ...
    def _train_one_batch(self, episode,batch_size,epoch):
        ...
        loss_mean = -prob_list.log().mean()/ self.env.problem_size
