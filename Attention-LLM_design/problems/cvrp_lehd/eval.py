...
if __name__ == "__main__":
    ...
    if mood == 'train':
        test_paras = {
            # problem_size: [filename, episode, batch, start_idx]
            200: ['vrp200_test_lkh.txt', 64, 64, 0],
            500: ['vrp500_test_lkh.txt', 64, 64, 0],
            1000: ['vrp1000_test_lkh.txt', 64, 64, 0],
        }
        ...
        if mood == 'val':
            test_paras = {
                # problem_size: [filename, episode, batch, start_idx]
                200: ['vrp200_test_lkh.txt', 32, 32, 64],
                500: ['vrp500_test_lkh.txt', 32, 32, 64],
                1000: ['vrp1000_test_lkh.txt', 32, 32, 64],
            }
        else:
            test_paras = {
                # problem_size: [filename, episode, batch, start_idx]
